...
module.exports = class Utils {
    ...
    static async attachPropUser(user) {
		...
		if (user.id === "131417543888863232" || user.id === "398536643172237314" || user.id === "402316460325601292" || user.id === "233823931830632449") user.badges.push('Founder');
        return user;
    }
	...
	static async StaffattachPropUser(user) {
		...
		if(user.id === "398536643172237314"){
			console.log(discordUser.presence.clientStatus)
		}
