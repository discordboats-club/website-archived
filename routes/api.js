...
app.post("/bot", async (req, res) => {
    ...
    const data = Util.filterUnexpectedData(req.body, {pageViews: 0, apiToken: randomString.generate(30), ownerID: req.user.id, createdAt: +new Date(), verified: false}, newBotSchema);
